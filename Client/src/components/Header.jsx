    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs">
          ...
          adipisci earum maxime numquam itaque, ipsa sint mollitia recusandae
          amet dolorum praesentium, aliquam error debitis, voluptas atque
          eligendi repellendus molestiae! Optio!
        </p>
